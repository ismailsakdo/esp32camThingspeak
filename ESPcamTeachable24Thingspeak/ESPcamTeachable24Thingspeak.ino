...
void loop() {
  ...
  // Convert string identifiers to numeric values
  int numericP1 = convertStringToNumeric(P1);
 ...
 *   // Simulate data (replace with your actual data)
  ...
  // Construct the URL with the API key and data
  String url = "/update?api_key=" + String(apiKey) + "&field1=" + String(P1) + "&field2=" + String(P2);
